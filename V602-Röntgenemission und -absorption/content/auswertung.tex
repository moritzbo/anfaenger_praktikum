...
\end{align}
Hier werden die Fehler durch die beiden fehlerbehafteten Energieterme bestimmt, mit folgender Fehlerfortpflanzung.
\begin{equation}
...
\sigma_2 &= Z_{\text{Cu}} - 2 \sqrt{\frac{R_{\infty}(z - \sigma_1)^2 - E_{\symup{K_{\alpha}}}}{R_{\infty}}} \\
\label{eqn:33}
\sigma_3 &= Z_{\text{Cu}} - 2 \sqrt{\frac{R_{\infty}(z - \sigma_1)^2 - E_{\symup{K_{\beta}}}}{R_{\infty}}} 
\end{align}
...
\end{align}
Die Fehler auf den Energien $E_{\symup{K_{\beta}}}$ und $E_{\symup{K_{\alpha}}}$ führen zu einem Fehler auf den Abschirmkonstante $\sigma_{2}$ und $\sigma_{3}$ gemäß.
\begin{align*}
\increment \sigma_{2} &= \left( \frac{R_{\infty}(z - \sigma_{1})^{2} - E_{\symup{K_{\alpha}}}}{R_{\infty}}\right)^{-1} \cdot \left( \frac{\increment E_{\symup{K_{\alpha}}}}{R_{\infty}}\right)^{2} \\
\increment \sigma_{3} &= \left( \frac{R_{\infty}(z - \sigma_{1})^{2} - E_{\symup{K_{\beta}}}}{R_{\infty}}\right)^{-1} \cdot \left( \frac{\increment E_{\symup{K_{\beta}}}}{R_{\infty}}\right)^{2}
\end{align*}
...
In der folgenden Tabelle ... sind die bestimmten Werte der Inensitätsmittelpunkte und die dazugehörigen Winkel grob abgeschätzt angegeben.
\begin{table}
\centering
