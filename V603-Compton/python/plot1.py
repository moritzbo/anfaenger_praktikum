...
plt.plot(theta, N, "k.", markersize =1.2,label="Bremsstrahlung")
...
plt.plot(theta1, n1, "gx" ,markersize=4, label=r"$K_{\beta}-\text{Linie}$")
plt.plot(theta2, n2, "bx",markersize=4, label=r"$K_{\alpha}-\text{Linie}$")
